    ...
    <div class="FlagPage">
      <div class="p-4 bg-white text-sky-500">
        <p>
          ...
          In the wake of the tragic 9/11 attack, I felt an even stronger calling within me to embark on a pathway to share this message of Peace. It was a resolute conviction that the people of our Earth needed a symbol, a flag, that could serve as a universal emblem of peace and hope. I envisioned a flag that transcended borders, languages, and cultures. A flag that belongs to every individual residing on this extraordinary planet.
        ...
        <img src="@\assets\Camille Yogi - Flag - Int Flag of Peace.png" alt="Flag" />
      </div>
    </div>
  </template>
