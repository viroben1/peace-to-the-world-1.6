<template>
    <div :class="{ 'HomePage': true, 'bg-gray-100': true, 'p-8': true, 'hidden': isPolicyPage }">
      ...
      <section class="mt-8">
        ...
        <p class=" text-sky-500">
          We are dedicated to promoting peace, unity, compassion and understanding among all people.
  ...
  export default {
    ...
    data() {
      return {
        // Assuming isPolicyPage is passed as a prop or calculated in the component
        isPolicyPage: false,
      };
    },
  };
